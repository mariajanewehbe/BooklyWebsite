...
app.get("/Recommendations", function (req, res) {
  ...
  ejs.renderFile(
    __dirname + "/views/Recommendations.ejs",
    { name: name, title: title },
    function (error, data) {
      res.send(data);
    }
